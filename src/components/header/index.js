    ...
    <div className={"container"}>
      ...
      <div className={"hamburger"}>
        <Hamburger
          ...
          toggled={isOpen}
          toggle={setOpen}
          color="rgba(138, 0, 0, 0.589)"
        />
        <div className={`backdrop${isOpen ? " is-active" : ""}`}></div>
        {isOpen && (
...
//{cn(header.backdrop, isOpen ? "child" : "")}
